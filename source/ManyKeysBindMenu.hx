...
class ManyKeyBindMenu extends FlxSubState
{
	...
	var keyText:Array<String> = [
		for (v in CoolUtil.numberArray(20, 0)) {
			v += ""
		}
	];
	var defaultKeys:Array<String> = ["Q", "W", "E", "R", "T", "Y", "U", "A", "S", "D", "F", "G", "H", "J", "Z", "X", "C", "V", "B", "N", "M"];
	var defaultArrowKeys:Array<String> = defaultKeys;

	var defaultGpKeys:Array<String> = ["DPAD_LEFT", "DPAD_DOWN", "DPAD_UP", "DPAD_RIGHT"]; //wtf
	var curSelected:Int = 0;

	var keys:Array<String> = [FlxG.save.data.M0Bind,
							  FlxG.save.data.M1Bind,
							  FlxG.save.data.M2Bind,
							  FlxG.save.data.M3Bind,
							  FlxG.save.data.M4Bind,
							  FlxG.save.data.M5Bind,
							  FlxG.save.data.M6Bind,
							  FlxG.save.data.M7Bind,
							  FlxG.save.data.M8Bind,
							  FlxG.save.data.M9Bind,
							  FlxG.save.data.M10Bind,
							  FlxG.save.data.M11Bind,
							  FlxG.save.data.M12Bind,
							  FlxG.save.data.M13Bind,
							  FlxG.save.data.M14Bind,
							  FlxG.save.data.M15Bind,
							  FlxG.save.data.M16Bind,
							  FlxG.save.data.M17Bind,
							  FlxG.save.data.M18Bind,
							  FlxG.save.data.M19Bind,
							  FlxG.save.data.M20Bind,
							  FlxG.save.data.M21Bind];
	...
	{	
		...
		infoText = new FlxText(-10, 580, 1280, 'Current Mode: ${KeyBinds.gamepad ? 'GAMEPAD wtf' : 'KEYBOARD'}. Press TAB to switch\n(${KeyBinds.gamepad ? 'RIGHT Trigger' : 'Escape'} to save, ${KeyBinds.gamepad ? 'LEFT Trigger' : 'Backspace'} to reset, ${KeyBinds.gamepad ? 'are u dumb' : 'L'} to set up for Arrow Keys. ${KeyBinds.gamepad ? 'START To change a keybind' : ''})', 72);
	...
	function save(){
		...
		for (v in CoolUtil.numberArray(0, 20)) {
			FlxG.save.data.["M"+v+"Bind"] = keys[v]
		}
	...
	function resetArrows(){
		...
		for(i in 0...defaultArrowKeys.length){
