...
# FNF vman keys mod
hit me up on the [issue tracker](https://github.com/VMan-2002/FNF-with-extra-keys/issues) for bugs and features

also [how do i make the glowing in the note assets](https://github.com/VMan-2002/FNF-with-extra-keys/issues/1)

## the regular kade engine readme below dis shit (idk why it's there but i'm keeping it i guess)
